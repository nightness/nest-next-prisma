...
var app_middleware_1 = require("../app.middleware");
function setupApp(app) {
    ...
    var appMiddleware = new app_middleware_1.AppMiddleware();
    app.use(appMiddleware.use.bind(appMiddleware));
    var listen = function () { return __awaiter(_this, void 0, void 0, function () {
        var server;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, app.listen(process.env.SERVER_PORT || 3000)];
                case 1:
                    server = _a.sent();
